...
import {
	...
	SystemProgram,
	Transaction,
	type TransactionConfirmationStrategy, // Add this line
...
export class RaydiumSwap {
	...
	async findRaydiumPoolInfo(
		...
		const collectedPoolResults = programData.flatMap((info) => ({
	...
	async sendLegacyTransaction(tx: Transaction): Promise<string> {
		...
		ll("Legacy transaction sent, signature:", signature);
	...
	async sendVersionedTransaction(
		...
		ll("Versioned transaction sent, signature:", signature);
